        ...
        <div className="col-12 col-md-10 col-lg-6 offset-md-1 offset-lg-0 row-content">
            <div className="h-100 d-flex flex-column py-5 px-4 px-sm-5 justify-content-center">
              ...
              <h4 className="font-size-subheader mb-4">
                <a href="https://commercejs.com/" target="_blank" className="cjs-link" rel="noopener noreferrer">re-integration.org</a>
                is a non-profit initiative that seeks to provide a safe-space for special-needs individuals to develop the foundational
                needs that allow them to become successful in society. 
              </h4>
